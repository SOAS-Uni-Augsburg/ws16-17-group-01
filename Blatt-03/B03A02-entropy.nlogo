...
to-report max-entropy
  report (log (count patches) 2)
end

to-report beans-per-patch
  report count turtles-here
end

to-report P-bean-on-patch
  report beans-per-patch / bean-count
end

to-report patch-entropy
  let P (P-bean-on-patch)
  ifelse P = 0
  [report 0]
  [report P * (log P 2)]
end
...
to-report entropy
  report (-1)*(sum [patch-entropy] of patches)
end
...
"pen-1" 1.0 0 -2674135 true "" "plot max-entropy"
